...
warm soup. They are content with you staying, but you wonder if you should
alert the world to this magical safe haven.`)
        if(thirdAnswer === 'stay') {
...
without proof, no one believes your story, which passes into legend nonetheless.`)
    } if(secondAnswer === 'contine') {
        let thirdAnswer = window.prompt(`You come across a chamber that reaches upward to 
a shining light above. There is a long, winding staircase, and a much quicker, but 
rickety-looking ladder that leads up toward the light. Which do you take?`)
        if(thirdAnswer === 'ladder') {
            window.alert(`After ascending a few feet up the ladder, one of its rungs snaps, and
you comedically fall through each of the rungs below. Sheepish, you return
home.`)
        } else if(thirdAnswer === 'staircase') {
            window.alert(`After ascending the staircase, you discover a shiny blue stone, which
you take home and cherish forever.`)
        }
    }
...
across a shiny blue flower. It is so beautiful that you decide you must
...
with your quill. You bring the drawing home, somewhat disappointed,
